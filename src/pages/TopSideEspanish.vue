...
<template>
  <div class="bg-[#18122e] w-full h-32 flex px-10 items-center justify-between animate__animated animate__fadeInDown">
    <div class="text-white">
      <p class="font-extrabold text-[18px] text-purple-500 bg-gradient-to-br from-purple-500 to-indigo-600 animate__animated animate__fadeInDown" style="-webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Hola, bienvenido!</p>
    ...
    <div class="flex items-center">
      ...
      <select class="text-white cursor-pointer bg-transparent w-32 text-xs gap-4 bg-violet-600 p-2 rounded outline-none" @change="goToPage">
        <option disabled class="text-slate-400">Elige un idioma</option>
        <option value="English" selected="selected">Inglés
        </option>
        <option value="Portuguese">Portugués</option>
        <option value="Espanish" selected="selected">Español</option>
      </select>
    </div>
  </div>
</template>